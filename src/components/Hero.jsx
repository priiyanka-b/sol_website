      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-28">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="relative z-10">
            ...
            >
              Premium Pre-Roll Solutions For{' '}
            ...
            >
              From custom branded pre-rolled cones and compliant retail packaging to 
              high-speed filling machinery — we help cannabis brands scale through 
              quality, compliance, and manufacturing innovation.
            </motion.p>
              ...
              <div className="relative w-full max-w-md">
                ...
                <div className="relative aspect-square rounded-3xl overflow-hidden bg-white border border-[#E2E8F0] shadow-premium shadow-dark-green/5">
                  <img
                    ...
                    alt="Premium custom pre-rolled cones and retail box packaging"
