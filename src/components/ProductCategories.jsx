...
const categories = [
  {
    ...
    tag: 'Most Popular',
    image:
      '/imgi_3_ccusa-home-25-pre-rolled-cones.jpg',
  },
  {
    icon: Palette,
    ...
    tag: null,
    image:
      '/imgi_18_Custom_Pre-Rolled_Cones_home_feat.jpg',
  },
  {
    icon: Package,
    ...
    tag: 'New',
    image:
      '/imgi_4_ccusa-home-25-artisan-tubes.jpg',
  },
  {
    icon: Factory,
    ...
    tag: 'Enterprise',
    image:
      '/imgi_72_Pre-Rolled_Cones_and_Tubes_2.jpg',
  },
  {
    icon: Truck,
